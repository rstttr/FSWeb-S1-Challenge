...
function indekseGoreFenomen(birDizi,birSayi) {
  /*kod*/
const secilenFenomen=birDizi[birSayi];
...
function platformaGoreCokGonderiYapanFenomen(birDizi,birPlatform){
  ...
  if (item.platform === birPlatform && maxPost < item.posts && typeof item.posts ==="number")
  {
    maxPost=item.posts;
